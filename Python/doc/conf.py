...
latex_documents = [
    (master_doc, 'PHATE.tex', 'PHATE Documentation',
     'Daniel Burkhardt, Krishnaswamy Lab, Yale University', 'manual'),
]
...
man_pages = [
    (master_doc, 'phate', 'PHATE Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PHATE', 'PHATE Documentation',
     author, 'PHATE', 'One line description of project.',
     'Miscellaneous'),
]
